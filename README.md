# AutoIQ
<<<<<<< HEAD
This is project is available for Desktop, mobile , browser and API validation.
=======

AutoIQ is now a JavaScript Selenium framework with built-in auto wait synchronization. The test layer does not use Playwright and does not need manual sleeps in test code.
